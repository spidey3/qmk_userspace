...
#define LRGB_CORNER_FL(color) { 8, 2, color }, { 16, 1, color }
#define LRGB_CORNER_FR(color) { 0, 1, color }, { 15, 1, color }, { 17, 1, color }
#define LRGB_CORNER_BR(color) { 1, 1, color }, { 19, 1, color }
#define LRGB_CORNER_BL(color) { 7, 1, color }, { 18, 1, color }
