...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_65_ansi_split_space(
        ...
        KC_LCTL,    KC_LGUI,    KC_LALT,              KC_A,               KC_B,               KC_C,                      KC_RALT,    KC_D,    KC_RCTL     KC_LEFT,    KC_DOWN,    KC_RGHT
    ),
    // Numpad
    ...
    // FN
    [_FN] = LAYOUT_65_ansi_split_space(
        ...
        _______,    _______,    _______,              KC_MPLY,              KC_MPLY,              KC_MPLY,                      KC_ASST,    _______,    _______,    KC_MPRV,    KC_VOLD,    KC_MNXT
    ),
